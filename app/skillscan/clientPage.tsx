...
// Utility to pick 8 random questions
...
export default function QuizPage() {
  // Initialize with 8 randomly picked questions
  ...
  const restartQuiz = () => {
    // Reshuffle and pick a new set of 8 random questions when restarting
    setRandomQuestions(getRandomQuestions(questions, 8));
  ...
  return (
    <div className="max-w-screen-2xl mx-auto px-4 md:px-24 py-8">
      ...
      <motion.h3
        ...
        pinpoints your specific data structure knowledge gaps, enabling targeted
        technical interview preparation and more effective learning.
      </motion.h3>
