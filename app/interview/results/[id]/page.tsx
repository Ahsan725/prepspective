            ...
            <li key={key} className="me-2">
              <button
                ...
                className={`inline-flex items-center justify-center p-4 border-b-2 ${
                  activeTab === key
                    ? 'text-white bg-indigo-700 font-semibold border-indigo-600 rounded-t-lg px-2 py-2 dark:text-indigo-500 dark:border-indigo-500'
                    : 'border-transparent px-2 py-2 font-semibold hover:text-indigo-700 hover:border-indigo-700 dark:hover:text-gray-300'
                }`}
              >
                {icon}
                {label}
