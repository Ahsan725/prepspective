  ...
  return (
    <div className="w-full max-w-6xl mx-auto relative">
      ...
      <Dialog open={isGuideOpen} onOpenChange={setGuideOpen}>
        <DialogContent className="fixed z-50 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 sm:max-w-[1200px] w-full p-8 bg-white rounded-lg shadow-lg">
          ...
          <DialogHeader>
            <DialogTitle className="text-2xl font-bold mb-4">How to Use Guide</DialogTitle>
            <DialogDescription>
              <ul className="list-disc ml-6 text-left space-y-4 text-lg">
                <li>
