...
<p className=" font-light text-gray-500 mt-10 text-2xl lg:text-4xl mb-16">
          ...
          <h2 className="inline-block tracking-tight leading-none mt-4 text-sm font-medium lg:text-lg border-2 border-indigo-700 text-indigo-700 bg-indigo-50 px-4 py-2 rounded-full">
