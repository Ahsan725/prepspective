...
export default function ModernHero() {
  ...
  const clients = [
    ...
    { name: 'Asana', src: '/asana.png' },
    { name: 'Atlassian', src: '/atlassian.png' },
    { name: 'Bank of America', src: '/bankofamerica.png' },
    { name: 'Capital One', src: '/capitalone.png' },
    { name: 'Chase', src: '/chase.png' },
    { name: 'Cisco', src: '/cisco.png' },
    { name: 'Cloudflare', src: '/cloudflare.png' },
    { name: 'Databricks', src: '/databricks.png' },
    ...
    { name: 'Wells Fargo', src: '/wellsfargo.png' },
    { name: 'Workday', src: '/workday.png' }
  ];
