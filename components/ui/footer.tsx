...
const sections = [
  ...
  },
  {
    ...
    links: [
      ...
      { name: 'Team', href: 'https://www.linkedin.com/in/ahsan-/' },
      { name: 'Blog', href: '#' },
      { name: 'Careers', href: '#' },
    ],
  },
      ...
      <div className="container mx-auto px-4">
        <footer>
          <div className="flex flex-col lg:flex-row items-center lg:items-start justify-between gap-10 text-center lg:text-left">
            ...
            <div className="flex w-full max-w-96 shrink flex-col items-center lg:items-start justify-between gap-6">
              ...
              <ul className="flex justify-center lg:justify-start items-center space-x-6 text-indigo-700">
            ...
            {/* Link Sections */}
            <div className="grid grid-cols-3 text-center gap-6 lg:gap-20 w-full max-w-xl">
          ...
          {/* Bottom bar */}
          <div className="mt-20 flex flex-col lg:flex-row justify-between gap-4 border-t pt-8 text-center text-sm font-medium text-gray-500 lg:text-left">
